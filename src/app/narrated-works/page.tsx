...
function AuthorPopup({
  ...
  const hasAnyLink = author.website || author.amazon || author.instagram || author.tiktok || author.threads || author.facebook || author.goodreads;
    ...
    >
      ...
      {hasAnyLink ? (
        <div className="px-2 py-2">
          ...
          <AuthorLink href={author.threads} label="Threads" icon={
            <svg viewBox="0 0 192 192" fill="currentColor" className="w-4 h-4"><path d="M141.537 88.988c-.827-.394-1.667-.775-2.518-1.141-1.482-27.255-16.051-42.94-41.48-43.077h-.761c-15.402 0-29.178 6.549-37.866 17.969l13.407 9.915c6.431-8.551 16.229-12.862 24.46-12.862h.562c9.428.056 16.551 2.86 20.162 8.09 2.54 3.676 4.233 8.655 5.003 14.672-6.21-1.112-12.851-1.482-19.897-1.118-24.649 1.324-39.978 15.95-39.057 35.859.468 10.205 5.332 18.908 13.796 24.595 7.144 4.84 16.282 7.306 25.799 6.82 12.489-.64 22.202-5.456 28.875-14.337 5.099-6.916 8.313-15.896 9.731-27.297 5.844 3.522 10.163 8.306 12.378 14.413 4.196 10.847 4.409 28.619-8.371 41.46-11.132 11.187-24.51 16.184-44.565 16.339-22.322-.163-39.205-7.106-50.186-20.638-10.336-12.729-15.619-31.438-15.836-55.621.217-24.183 5.5-42.892 15.836-55.621 10.981-13.532 27.864-20.475 50.186-20.638 22.481.165 39.547 7.142 50.699 20.813 5.53 6.774 9.618 15.303 12.139 25.295l13.906-3.782c-3.041-11.942-8.087-22.24-15.067-30.684-13.817-16.598-34.023-25.098-61.623-25.315h-.054c-27.54.217-47.607 8.748-61.202 25.415-12.102 14.841-18.338 35.934-18.554 62.518.216 26.584 6.452 47.677 18.554 62.518 13.595 16.667 33.662 25.198 61.202 25.415h.054c24.464-.182 41.847-6.926 55.342-20.487 18.014-18.096 17.401-40.815 11.491-55.565-3.808-9.535-11.516-17.36-26.336-25.334zM102.488 132.516c-9.54.466-18.493-3.278-18.888-12.659-.291-6.637 4.609-13.695 18.419-14.45 1.603-.09 3.177-.132 4.721-.132 5.692 0 11.024.568 15.878 1.659-1.863 21.065-11.415 25.039-20.13 25.582z"/></svg>
          } />
