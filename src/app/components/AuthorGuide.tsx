...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    tips: [
      ...
      "For Authors Republic projects: deliver a direct download link or use a service like BookFunnel to distribute audio files securely",
      "BookTok romance reviewers are often more likely to create video content for an ALC than a traditional ARC — audio is great content",
      "Target ARC/ALC readers who review in your genre — a cozy mystery reviewer won't help your dark romance",
      "Don't ask for positive reviews — ask for honest ones. Authenticity converts better",
      "Schedule distribution at least 3 weeks before launch so reviews are live in time",
      "Platforms like BookSirens now support both ebook ARC and audio ALC distribution in one place",
    ],
    resources: [
      { label: "BookSirens: ARC & ALC management", href: "https://booksirens.com" },
      { label: "StoryOrigin: ARC, ALC & newsletter tools", href: "https://storyoriginapp.com" },
      { label: "NetGalley: Trade ARC platform", href: "https://www.netgalley.com" },
      { label: "BookFunnel: Secure audio delivery", href: "https://bookfunnel.com" },
    ],
  },
  {
    id: "launch-marketing",
