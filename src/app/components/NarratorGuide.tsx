...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    detail: "ACX offers three payment models. Per Finished Hour (PFH): you're paid a flat rate per finished hour of audio — the most predictable and usually the best deal for narrators since the vast majority of indie audiobooks sell fewer than 100 copies. Royalty Share (RS): you receive 20% of net sales for 7 years in exchange for no upfront payment — this locks both parties into ACX exclusivity and is a gamble; most RS titles generate little ongoing income. Royalty Share Plus (RS+): a hybrid — you receive a reduced PFH stipend upfront plus a royalty share. It lowers your risk compared to pure RS while still giving the author a cost break. RS+ can make sense for a project you genuinely believe in, or from an author with a proven sales track record. PFH rates on ACX typically range from $100–$400+ per finished hour. Off-platform work (Authors Republic, direct contracts) is always PFH and often commands stronger rates.",
    tips: [
      "As a general benchmark, aim for $200 PFH or above — unless you are truly passionate about a specific project or the author has a strong sales track record that makes RS or RS+ genuinely worthwhile",
      "If you're just starting out, accepting lower rates to build your portfolio is understandable — but raise your rates deliberately as your experience grows, not just when you feel ready",
      "Royalty Share locks you to Audible for 7 years — the contract auto-renews and can only be dissolved with mutual consent. Read it carefully before accepting",
      "RS+ (Royalty Share Plus) offers a small upfront PFH stipend plus royalties — a middle ground worth considering for authors you trust or books with genuine commercial potential",
      "SAG-AFTRA members: the union has 90+ separate audiobook agreements with publishers. Minimums generally start at $200–$275 PFH plus pension and health contributions. ACX can be done under union contract if your rate is at least $250 PFH — a paymaster handles the contributions",
      "Non-union narrators are not penalised for doing non-union audiobook work — there is no Global Rule One for audiobooks, so you can do both union and non-union projects freely",
      ...
      "Keep records of every payment, contract, and delivery — you're running a business",
      "A 90,000-word book = roughly 10 finished hours = 30+ hours of total work at minimum (recording, editing, mastering, proofing, corrections)",
    ],
    resources: [
      { label: "ACX: Payment & royalty information", href: "https://www.acx.com/help/payment/201370340" },
      { label: "Narrators Roadmap: ACX RS/RS+ contract explained", href: "https://www.narratorsroadmap.com/can-the-rh-buy-out-an-acx-rs-or-rs-contract/" },
      { label: "SAG-AFTRA: Audiobook contracts & rates", href: "https://www.sagaftra.org/contracts-industry-resources/audiobooks" },
      { label: "GVAA Rate Guide: Non-union audiobook rates", href: "https://globalvoiceacademy.com/sag-aftra-rates/" },
      { label: "Audio Publishers Association", href: "https://www.audiopub.org" },
    ],
  },
  {
    id: "building-brand",
  ...
  },
  {
    ...
    tips: [
      ...
      "Audie Awards and APA events are where relationships get built — attend even as a listener before you're ready to pitch yourself",
      "Narrators Roadmap and narrator.life community members often share casting opportunities, open calls, and industry connections — staying active in these communities pays off",
      "Consider joining SAG-AFTRA — one qualifying audiobook at $250+ PFH via ACX is all it takes. Union membership signals professionalism to major publishers",
    ],
    resources: [
      { label: "AHAB Talent: Create a narrator profile", href: "https://www.ahabtalent.com" },
      { label: "PRH Audio: Narrator Mentorship Program", href: "https://penguinrandomhouseaudio.com/narrator-mentorship/" },
      { label: "PRH Audio: Work with us (casting info)", href: "https://penguinrandomhouseaudio.com/work-with-us/" },
      { label: "APA: Audio Publishers Association annual conference", href: "https://www.audiopub.org/events" },
      { label: "SAG-AFTRA: Audiobook narrators", href: "https://www.sagaftra.org/contracts-industry-resources/audiobooks" },
    ],
  },
  {
    id: "growing-roster",
