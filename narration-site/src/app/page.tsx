          ...
          <div className="relative max-w-6xl mx-auto px-6 py-16 md:py-20">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-center">
              <div className="md:col-span-7">
                ...
                {/* Updated: richer navy cards + subtle hover */}
              ...
              {/* Updated: navy panel instead of white/5 */}
                ...
                <div className="relative rounded-2xl border border-[#1A2550] bg-[#050814] p-6 shadow-xl">
                  ...
                  <div className="mt-6 rounded-xl border border-[#1A2550] bg-[#0B1224] p-4">
                    ...
                    <p className="mt-1 text-sm text-white/80">
                      Include genre, word count, deadline, and any character
                      notes.
                    </p>
                  </div>
                </div>
...
For me, narration is about connection. It’s the moment a listener forgets there’s a narrator at all and simply feels the story.
              ...
              <div className="md:col-span-4">
                <div className="rounded-2xl border border-[#1A2550] bg-[#0B1224] p-6 shadow-lg">
                  ...
                  <p className="mt-4 text-sm text-white/70">
                    Include word count, deadline, genre, POV, and any character
                    notes.
                  </p>
                </div>
              </div>
          ...
          <section id="contact" className="mt-20">
            ...
            <p className="mt-2 text-white/70">
              Send word count, deadline, genre, and any character notes. I will
              reply with availability and a quote.
            </p>
